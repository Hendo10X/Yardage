...
export const Hero = () => {
  return (
    <div className='flex flex-col h-screen'>
        <div className='flex flex-col px-6 md:px-28 py-6 md:py-14'>
            <div className='flex flex-col gap-4'>
                <h1 className='md:text-[57px] text-[40px] font-bold flex flex-col leading-[100%]'>
                <span>Turn Dorm</span> 
                    <span className='text-primary'>Clutter Into Cash</span>
                </h1>
                <p className='md:text-[20px] text-[18px] text-[#828181] flex flex-col gap-0'>
